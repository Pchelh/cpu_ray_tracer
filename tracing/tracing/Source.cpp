...
int main() {
	...
	//spheres.push_back(Sphere(Vec3f(-3.0, 2.5, -12), 2, glass));
	spheres.push_back(Sphere(Vec3f(-0.5, 5.5, -12), 3, red_rubber));
	spheres.push_back(Sphere(Vec3f(-8, 6, -18), 4, mirror));

	std::vector<Light>  lights;
	lights.push_back(Light(Vec3f(-20, 20, 20), 1.5));
	lights.push_back(Light(Vec3f(30, 50, -25), 1.8));
	lights.push_back(Light(Vec3f(30, 20, 30), 1.7));
	lights.push_back(Light(Vec3f(40, 50, 30), 2.7));
